...
async function customSave(path, options) {
...
const plugin = {
    ...
    autoStart: true,
    activate: async (app, browser, translator, launcher, notebookTracker) => {
        ...
        serviceManager.contents.save = customSave.bind(serviceManager.contents);
    }
};
