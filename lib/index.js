...
const callParent = (action) => new Promise((res, rej) => {
 ...
 */
function customDriveForPath(path) {
...
const plugin = {
    ...
    autoStart: true,
    activate: async (app, browser, translator, launcher, notebookTracker, docManager) => {
        ...
        serviceManager.contents._driveForPath = customDriveForPath.bind(serviceManager.contents);
    }
};
